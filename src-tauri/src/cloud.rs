...
#[tauri::command]
pub fn secret_read(source: String, key: String) -> Result<String, String> {
...
#[tauri::command]
pub fn aws_list(service: String) -> Result<String, String> {
...
#[tauri::command]
pub fn aws_profiles() -> Result<String, String> {
